...
const HeaderSection = ({ data }) => {
  ...
  const expPercent =
    stats.maxExp > 0 ? (stats.currentExp / stats.maxExp) * 100 : 0;
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 mb-8 text-center md:text-left">
          <div className="w-full md:w-auto">
            {/* 수정됨: justify-center md:justify-start 추가 (뱃지 중앙 정렬) */}
            <p className="text-slate-400 mb-1 flex items-center justify-center md:justify-start gap-2 text-sm font-medium">
          ...
          {/* 수정됨: w-full md:w-auto 및 justify-center md:justify-end 추가 (박스 그룹 중앙 정렬) */}
          <div className="flex gap-4 w-full md:w-auto justify-center md:justify-end">
            <div className="bg-slate-800/50 backdrop-blur-md border border-white/5 px-5 py-3 rounded-2xl flex items-center gap-3">
              ...
              {/* 텍스트 왼쪽 정렬 강제 (박스 내부는 왼쪽 정렬이 깔끔함) */}
