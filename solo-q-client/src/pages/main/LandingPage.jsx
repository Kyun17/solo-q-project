...
import { VideoCamera, Notebook, UsersThree, PlayCircle, Atom, Database, Cloud } from '@phosphor-icons/react';
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
                ...
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-blob" style={{ animationDelay: '2s' }}></div>
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    >
                        스터디 구할 필요 없이, 웹캠 하나로 실전처럼 연습하세요.<br className="hidden md:block" />
                        예상 질문 관리부터 모의 면접 녹화, 피드백까지 한 번에 해결해 드립니다.
                    </motion.p>
                    ...
                    >
                        <Link to="/dashboard" className="w-full md:w-auto px-8 py-4 bg-gradient-to-r from-purple-600 to-fuchsia-600 rounded-full text-white font-bold text-lg hover:shadow-lg hover:shadow-purple-500/40 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2">
            ...
            <section className="py-10 border-y border-white/5 bg-black/20 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 opacity-60">
                    <span className="text-sm font-semibold text-slate-500 uppercase tracking-widest hidden md:block">Powered by</span>
                    <div className="flex flex-wrap justify-center gap-8 md:gap-12 text-xl font-bold text-slate-400">
                        <div className="flex items-center gap-2"><Atom size={24} className="text-blue-400" /> React</div>
                        <div className="flex items-center gap-2"><Database size={24} className="text-green-400" /> Spring Boot</div>
                        <div className="flex items-center gap-2"><div className="w-6 h-6 bg-red-500 rounded flex items-center justify-center text-xs text-white">O</div> Oracle</div>
                        <div className="flex items-center gap-2"><Cloud size={24} className="text-cyan-400" /> WebRTC</div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold mb-4">
                            합격을 위한 <span className="text-purple-400">Solo-Q</span>만의 솔루션
                        </h2>
                        <p className="text-slate-400">면접 준비의 A to Z를 빈틈없이 채워드립니다.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className={`p-8 rounded-3xl bg-slate-800/40 border border-slate-700 backdrop-blur-sm hover:-translate-y-2 transition-transform duration-300 ${feature.highlight ? 'border-purple-500/50 shadow-lg shadow-purple-500/10' : ''}`}>
